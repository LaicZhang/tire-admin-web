...
function prepareDetail(detail: OutboundOrderDetail): OutboundOrderDetail {
  return {
    ...detail,
...
function prepareFormData(order: OutboundOrder): OutboundOrder {
  return {
    ...order,
...
function syncDetailSerialNumbers(row: OutboundOrderDetail) {
