      ...
      <article class="trace-panel">
        ...
        <div v-if="claims.length" class="claim-list">
          ...
          >
            ...
            <span>{{
              item.identificationResult || item.oldTireDisposition || "-"
            }}</span>
...
.serial-trace-page {
  ...
  --trace-panel: rgb(255 255 255 / 84%);
  --trace-border: rgb(17 24 39 / 8%);
  --trace-strong: #0f172a;
  --trace-muted: #526072;
  --trace-accent: #bb4d00;
  --trace-accent-soft: rgb(187 77 0 / 12%);
