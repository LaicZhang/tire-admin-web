...
import {
  ...
  supplierClaimOrderDetailsColumns,
...
const columnsMap: Record<ORDER_TYPE, TableColumnList> = {
  ...
  [ORDER_TYPE.supplierClaim]: supplierClaimOrderDetailsColumns,
...
const formRulesMap: Record<ORDER_TYPE, FormRules> = {
  ...
  [ORDER_TYPE.supplierClaim]: supplierClaimOrderFormRules,
